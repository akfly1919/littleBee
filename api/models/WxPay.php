...
class WxPay
{
    ...
    **/
    ...
    public static function MakePaySign($arr, $signType, $key)
    {
        //签名步骤一：按字典序排序参数
        ksort($arr);
        //签名步骤二：在string后加入KEY
    ...
    public static function unifiedOrder($conf, $openId, $attach, $body, $ip, $price, $tradeType, $sceneInfo, $tradeid) {
//        return array(
//            'return_code' => 'SUCCESS',
//            'result_code' => 'SUCCESS',
//            'mweb_url' => 'http://www.baidu.com',
//            'code_url' => 'http://www.google.com',
//        );
        ...
        if ($tradeType == "JSAPI") {
            ...
            $xml = $input->ToXml();
            //print_r($xml);//exit;
            $url = $conf["createOrderUrl"];
            $res = WxPay::postXmlCurl($xml, $url, false, 30);
            //print_r($res);exit;
