...
require_once dirname(dirname(__DIR__)) . '/api/aliyun/sms/sdk/vendor/autoload.php';
 ...
 * Class Sms
 *
 * 这是短信服务API产品的，直接执行此文件即可体验短信服务产品API功能
...
{ 
    ...
    public static function getAcsClient() {
        ...
        $accessKeyId = "LTAIsH2HsJQUspLc"; // AccessKeyId

        $accessKeySecret = "A32sz3ksdikQpF4kqgSsb7PvH2mD3h"; // AccessKeySecret
     ...
     * 发送短信
     */
    public static function sendSms($phone, $msgCode) {
        ...
        $request->setSignName("小蜜蜂官微");

        // 必填，设置模板CODE，应严格按"模板CODE"填写, 请参考: https://dysms.console.aliyun.com/dysms.htm#/develop/template
        $request->setTemplateCode("SMS_137735056");
